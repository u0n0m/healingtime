...
public class Aromalist_data {
    public final String[] aroma_name = new String[]{"Basil", "Bergamot - Calabrian", "Cedarwood Atlas", "Citronella Ceylon", "Clary Sage", "Cypress French", "Eucalyptus Blue Gum", "Fennel Sweet", "Frankincense", "Geranium Egypt", "Ginger", "Grapefruit White",
    ...
    public final String[] aroma_sub_name = new String[]{"Ocimum basilicum", "Citrus bergamia", "Cedrus atlantica", "Cymbopogon nardus", "Salvia sclarea", "Cupressus sempervirens", "Eucalyptus Radiata", "Foeniculum vulgare dulce", "Boswellia carteri",
    ...
    public final int[] icon = new int[]{R.drawable.aroma_basil, R.drawable.aroma_bergamot_calabrian, R.drawable.aroma_cedarwood_atlas, R.drawable.aroma_citronella_ceylon, R.drawable.aroma_clary_sage, R.drawable.aroma_cypress_french,
    ...
    public final String[] aroma_extract_part = new String[]{"잎, 꽃", "열매껍질", "목질부", "수지", "잎, 꽃", "솔잎, 작은가지", "잎", "씨앗", "수지", "X", "뿌리", "열매껍질", "베리(열매)", "X", "꽃", "꽃", "꽃", "꽃", "꽃", "Peel of the fruit", "잎", "열매껍질",
            "열매", "열매껍질", "꽃, 잎", "수지", "열매껍질", "잎", "잎", "솔잎", "솔잎, 작은가지", "꽃이 핀 허브", "꽃이 핀 허브", "잎, 줄기", "허브", "목질부", "꽃", "열매껍질", "잎", "상단부(꽃, 잎등)", "뿌리", "꽃", "꽃"};

    public final String[] aroma_extract_method = new String[]{"수증기증류법", "냉압착법", "수증기증류법", "증류법", "증류법", "증류법", "증류법", "수증기증류법", "증류법", "X", "증류법", "냉압착법", "수증기증류법", "증류법", "수증기증류법 (40/42% Ester)",
    ...
    public final String[] aroma_country_origin = new String[]{"이탈리아", "이탈리아", "USA", "스리랑카", "불가리아", "X", "중국", "프랑스", "X", "X", "프랑스", "프랑스", "X", "프랑스", "프랑스", "X", "프랑스", "프랑스", "프랑스",
            "이탈리아", "인도", "이탈리아", "호주", "X", "스페인", "아프리카", "브라질", "인도", "X", "USA", "헝가리", "USA", "USA", "프랑스", "튀니지", "브라질", "USA", "X", "호주", "스페인", "자바", "프랑스", "프랑스"};

    public final String[] aroma_detailed_instructions = new String[]{"일년생 식물인 바질은 20~50 센티가량 자라며 개화시에는 보라색과 흰색의 꽃들이 송이를 지어 피고 타원형의 끝이 뾰족한 녹색의 잎을 가졌습니다. 아유로베딕에서는 바질은 연민과 믿음을 증강시키고 정화하는 능력이 있다고 소중히 여겨졌습니다. 바질은 부비강염에 좋고, 소화를 촉진하며 순환계 특히 호흡계를 자극합니다.",
    ...
    public final String[] aroma_color = new String[]{"녹색톤을 띈 황금빛 노란색", "녹색빛을 띈 노란색", "연한 금빛의 노란색", "옐로브라운", "라이트골든옐로", "옅은 노란색", "무색", "옅은 노란색을 띈 무색", "옅은 연두색", "X", "옅은 노란색", "옅은 노란색", //12
    ...
    public final String[] aroma_blending_oil = new String[]{"버가못, 클라리세이지, 클로브버드, 라임, 유칼립투스, 주니퍼, 레몬, 네롤리, 로즈마리",
    ...
    public final String[] aroma_history = new String[]{"그리스어로 왕실체료제 또는 왕이라는 뜻의 바질은 인도, 아시아, 지중해 나라들에서 식용허브 자주 쓰입니다.",
    ...
    public final String[] aroma_caution = new String[]{"민감성 피부에 자극을 줄 수도 있습니다. 임신중 사용은 피하십시요.",
