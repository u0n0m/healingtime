...
public class ColorAlarmListviewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView week_sum = (TextView) convertView.findViewById(R.id.week_sum) ;
        View color_type = (View) convertView.findViewById(R.id.color_type) ;
        TextView color_description = (TextView) convertView.findViewById(R.id.color_description) ;
        ...
        //color_type.setDrawingCacheBackgroundColor(listViewItem.getType());
    ...
    public void addItem( String s_ampm, String s_hour, String s_min, String e_ampm, String e_hour, String e_min,
                         String week_sum, Integer color_bright,String color_type, Drawable icon) {
